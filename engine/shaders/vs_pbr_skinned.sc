...
void main()
{
    // Compute skinned position using bone matrices from u_model[].
    ...
    // Clip position -- use u_viewProj since model transform is baked into bone matrices.
